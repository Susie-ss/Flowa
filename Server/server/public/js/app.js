...
function showDownloadPluginModal() {
  ...
  modal.innerHTML = '<div class="modal" style="width:560px" onclick="event.stopPropagation()">' +
    ...
    '<div class="modal-actions">' +
      '<button class="btn btn-primary" onclick="showToast(\'下载功能开发中，敬请期待\',\'success\');document.getElementById(\'plugin-modal\').remove()"><svg class="icon-color icon-sm"><use href="/libs/iconpark/icons.svg#ico-download"/></svg> 立即下载</button>' +
    '</div>' +
  '</div>';
